	...
	DisplayEmpData(){
		...
		searchbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					refresh();
					String string = "SELECT * from employees where emp_no like ? ;";
		...
		editbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String string = "Update employees set last_name = ? where emp_no = ?";
					PreparedStatement stmt = conn.prepareStatement(string);
		...
		removebtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(a==JOptionPane.YES_OPTION){
					try {
						String string = "Delete from employees where emp_no = ? ;";
						PreparedStatement stmt = conn.prepareStatement(string);
...
//		setContentPane(Panel2);
		...
		btnNewButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				try {
					String string = "INSERT into employees values(?, ?, ?, ?, ?, ?);";
					PreparedStatement stmt = conn.prepareStatement(string);
